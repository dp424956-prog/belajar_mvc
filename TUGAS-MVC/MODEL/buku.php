...
class Buku {
    ...
    public static function semuaBuku() {
        ...
        $buku2 = new Buku("Matematika", "alpin", 2019);
        $buku3 = new Buku("Ilmu pengetahuan Sosial", "sohir", 2021);
        $buku4 = new Buku("Pembataian Rakyat", "rojak", 2018);
        $buku5 = new Buku("Madigol", "rahmad", 2022);
        $buku6 = new Buku("Tidur di bumi", "suadi", 2015);
